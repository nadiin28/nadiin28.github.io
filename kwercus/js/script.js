window.addEventListener('DOMContentLoaded', () => {
  ...
  */
  ...
  tabsContainer.addEventListener('touchstart', startDragging);
  tabsContainer.addEventListener('touchmove', drag);
  tabsContainer.addEventListener('touchend', stopDragging);
  tabsContainer.addEventListener('touchcancel', stopDragging);
  ...
  function showMobileBasket() {
    if (mobileBool == true) {
      ...
      mobile_basket.classList.remove('basket__mobile-active');
      document.querySelector('.bypro').style.marginBottom = '0';
    }
  }
